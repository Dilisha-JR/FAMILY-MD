...
Examples:
.sinhalasub2 Iron Man
.sinhalasub2 Avengers
.sinhalasub2 Spider-Man
            ...
            if (isReplyToSentMsg) {
                ...
                if (selectedIndex >= 0 && selectedIndex < movies.length) {
                    ...
                    try {
                        ...
                        const detailResponse = await axios.get(`https://pixeldrain.com/api/file/${encodeURIComponent(selectedMovie.link)}`);
